...
const URL = `${environment.apiUrl}/lesson`;
...
export class LessonService {
  ...
  public updatedLesson(editLessonRequest: EditLessonRequest): Observable<LessonDTO>{
    return this.http.put<LessonDTO>(`${URL}/update`, editLessonRequest);
  }
}
